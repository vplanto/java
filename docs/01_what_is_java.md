## Лекція 3: Архітектура Java та порівняльний аналіз
...
керувавсякерувавсяккерувавсяерувався
Проєкт керувався п'ятьма головними цілями, які й визначили філософію Java:
1.  **Об'єктно-орієкерувавсянтованість:** Мова мала бути побудована навколо концепції об'єктів.
...
Звісно. Ось секція з контрольними питаннями, що охоплює всі теми з лекції, у форматі, подібному до екзаменаційного.
