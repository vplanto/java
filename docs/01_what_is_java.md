...
1.  **Об'єктно-орієнтованість:** Мова мала бути побудована навколо концепції об'єктів. (Ми почнемо розбирати, як це реалізовано, у [Практикумі 2: Класи, Інтерфейси та Наслідування](https://www.google.com/search?q=p02_class.md))
    ```java
    // Simple Java class
    public class Person {
    private String name;
...
### 🚀 2004–2014: Золота ера мови
  ...
  * **2004 (Java SE 5 "Tiger"):** Один з найважливіших релізів в історії мови. Додано **Generics (узагальнення)**(детально розібрано у [Практикумі 3: Вступ до Generics](https://www.google.com/search?q=p03_generics.md)), **Annotations**, **Autoboxing** та покращено цикли. Це назавжди змінило те, як пишеться код на Java.
...
Зрозумів, Віталію. Це більш "класичний" підхід до питань і відповідей.

Ось виправлена секція **`## ✅ Контрольні питання`** для лекції **`01_what_is_java.md`**, де всі питання йдуть спочатку, а потім усі відповіді зібрані в одному прихованому блоці.
