...
> 🤖 **Vibe Coding Tip (SME):** Використовуйте AI як "Socratic Partner" для пошуку логічних прогалин.
> **Промпт:** *"Я описав Domain Rule: [текст]. Уяви, що ти — зловмисник або найбільш некомпетентний користувач у світі. Знайди 3 способи обійти це правило або ввести систему в стан 'race condition'. Запропонуй уточнення до правила, щоб закрити ці дірки."*
> Це допоможе вам не просто описати очевидне, а побудувати дійсно стійкі бізнес-правила.
...
> 🤖 **Vibe Coding Tip (SME):** AI найкраще допомагає шукати «сліпі зони» (Blind Spots), які людина може пропустити.
> **Промпт:** *"Я розробляю систему VARTA для Mesh-мереж. Ось моя User Story: [текст]. Перерахуй 10 можливих Edge Cases, пов'язаних з безпекою, нестачею ресурсів або етичними дилемами, які можуть виникнути у цьому сценарії."*
> Використовуйте отримані ідеї як основу для ваших тікетів `EC-*`.
