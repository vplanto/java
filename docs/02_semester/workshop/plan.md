...
## 🔄 Механіка Ротації
Наприкінці кожного Спринта (що дорівнює 2-3 лабораторним заняттям) сквад перерозподіляє ролі. Це дозволяє кожному студенту спробувати себе в усіх аспектах команди: від збору вимог до кодування та інфраструктури, формуючи справжніх кросфункціональних фахівців.
