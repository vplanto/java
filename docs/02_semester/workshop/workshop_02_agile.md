...
Цей розділ є точкою входу для практичної роботи другого семестру. Ми розділяємо практику на два паралельні треки:

1.  **Scrum Track (Проєкт "VARTA")** — командна симуляція Agile-процесів.
    *   **[Матеріали для сквадів (Backlog, Templates, SM Guides)](scrum/index.md)**
2.  **Engineering Track (P02–P09)** — технічні лабораторні роботи.
    *   **[Перейти до технічних практикумів](engineering/)**

---

## 🎮 Практикум: Scrum Ceremonies. Case Study

**Ціль:** Провести симуляцію 4 основних Scrum-церемоній (Sprint Planning, Daily Scrum, Sprint Review, Sprint Retrospective) на прикладі реалістичного продуктового проєкту. Зрозуміти механіку виявлення проблем і прийняття рішень командою. Перед Planning на воркшопі VARTA команда має вже пройти **Backlog Refinement** — див. [Sprint Grooming і Planning](scrum/plan.md#grooming-and-planning).
...
- [План воркшопу](scrum/plan.md)
- [Повний Product Backlog проекту VARTA](scrum/product_backlog.md)
...
- **Сквад (Squad):** Група з ~7 студентів, що включає ролі Dev, QA, SME та Ops (згідно з [планом](scrum/plan.md)).
...
**На воркшопі:** сквад робить refinement **до** рольової гри Planning (див. [план VARTA](scrum/plan.md#grooming-and-planning)): перегляд [беклогу](scrum/product_backlog.md), питання до PO, чернетки вимог за ролями. На **Sprint Planning** не варто витрачати весь час на перше знайомство зі story — там фокус на **виборі** роботи на спринт і **Sprint Goal**.
...
1. **PO нагадує пріоритет і прогрумовані задачі** — показує верхівку [Product Backlog](scrum/product_backlog.md) (топ за пріоритетом); елементи вже **уточнені на refinement**, інакше повертаємось до уточнень (міні-grooming).
