...
- **Waterfall без ітерацій.** Вимоги збирались роками. Жодного ранньго тестування з реальним навантаженням. Перше «повноцінне» тестування — за два тижні до релізу.
...
> 💡 **Висновок:** Церемонії Scrum — це **інструмент, а не мета**. Daily займає 15 хвилин тільки якщо це справжній health-check команди, а не звіт для менеджера. Якщо ви витрачаєте більше часу на розговори про роботу, ніж на саму роботу — щось пішло не так.
