...
Когнітивна психологія підтверджує: **негативний досвід** залишає сильніший слід у пам'яті, ніж позитивний (так звана *negativity bias*). Розбираючи провали, ви набагато краще засвоєте *чому* метрика важлива, ніж читаючи абстрактні поради «вимірюйте Lead Time».
